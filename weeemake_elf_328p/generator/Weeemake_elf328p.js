...
//
Blockly.Arduino.wm_elf328p_single_led = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//Buzzer
Blockly.Arduino.wm_elf328p_buzzer_play_beat_ob = function() {
...
Blockly.Arduino.wm_elf328p_buzzer_play_pitch_ob = function() {
...
//Sound Sensor
Blockly.Arduino.wm_elf328p_sound_sensor = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['sound_sensor'+dropdown_pin] = 'WeSoundSensor sound_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
  var code = 'sound_'+dropdown_pin[5]+'.read()';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

//Sound Sensor
Blockly.Arduino.wm_elf328p_light_sensor = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['light_sensor'+dropdown_pin] = 'WeLightSensor light_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
  var code = 'light_'+dropdown_pin[5]+'.read()';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

//IR Sensor
Blockly.Arduino.wm_elf328p_ir_loop = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
Blockly.Arduino.wm_elf328p_ir = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
//RGB LED
Blockly.Arduino.wm_elf328p_rgb_on_board = function() {
...
Blockly.Arduino.wm_elf328p_rgb_on_board_1 = function() {
...
Blockly.Arduino.wm_elf328p_rgb_ring_1 = function() {
  var pixel = Blockly.Arduino.valueToCode(this, 'PIXEL', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  pixel  = pixel > 8 ? 8 : pixel;
  pixel  = pixel < 0 ? 0 : pixel;
  var colour_rgb_led_color = this.getFieldValue('RGB_LED_COLOR');
...
Blockly.Arduino.wm_elf328p_rgb_rj = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var pixel = Blockly.Arduino.valueToCode(this, 'PIXEL', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  pixel  = pixel > 5 ? 5 : pixel;
  pixel  = pixel < 0 ? 0 : pixel;
  var red = Blockly.Arduino.valueToCode(this, 'RED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var green = Blockly.Arduino.valueToCode(this, 'GREEN', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var blue = Blockly.Arduino.valueToCode(this, 'BLUE', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
...
Blockly.Arduino.wm_elf328p_rgb_rj_1 = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var pixel = Blockly.Arduino.valueToCode(this, 'PIXEL', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  pixel  = pixel > 5 ? 5 : pixel;
  pixel  = pixel < 0 ? 0 : pixel;
...
Blockly.Arduino.wm_elf328p_rgb_strip = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var pixel = Blockly.Arduino.valueToCode(this, 'PIXEL', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var red = Blockly.Arduino.valueToCode(this, 'RED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var green = Blockly.Arduino.valueToCode(this, 'GREEN', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
...
Blockly.Arduino.wm_elf328p_rgb_strip_1 = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var pixel = Blockly.Arduino.valueToCode(this, 'PIXEL', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var colour_rgb_led_color = this.getFieldValue('RGB_LED_COLOR');
  var color = goog.color.hexToRgb(colour_rgb_led_color);
...
//Button
Blockly.Arduino.wm_elf328p_button_on_board = function() {
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
Blockly.Arduino.wm_elf328p_button_rj = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_elf328p_button_rj_set_led = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//Motor and Servo
Blockly.Arduino.wm_elf328p_dc_motors = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_elf328p_servos = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  ...
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['wm_elf328p_servos'+dropdown_pin] = 'Servo servo_'+dropdown_pin[5]+';';
  Blockly.Arduino.setups_['wm_elf328p_servos_setup'+dropdown_pin] = 'servo_'+dropdown_pin[5]+'.attach('+dropdown_pin+');';
  var code = 'servo_'+dropdown_pin[5]+'.write('+degree+');\n';
  return code;
};


Blockly.Arduino.wm_elf328p_130_dc_motor = function() {
	var dropdown_pin = this.getFieldValue('PIN');
	var speed = Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
	speed	= speed > 255 ? 255 : speed;
  speed	= speed < -255 ? -255 : speed;
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
	Blockly.Arduino.definitions_['wm_elf328p_130_dc_motor'+dropdown_pin] = 'We130DCMotor motor130_'+dropdown_pin[5]+'('+dropdown_pin+');';
	var code = 'motor130_'+dropdown_pin[5]+'.run('+speed+');\n';
	return code;
};

Blockly.Arduino.wm_elf328p_encoder_motor_run = function() {
	var dropdown_pin = this.getFieldValue('PIN');
	var speed = Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
	speed	= speed > 255 ? 255 : speed;
  speed	= speed < -255 ? -255 : speed;
...
Blockly.Arduino.wm_elf328p_encoder_motor_runSpeed = function() {
	var dropdown_pin = this.getFieldValue('PIN');
	var speed = Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
	speed	= speed > 255 ? 255 : speed;
  speed	= speed < -255 ? -255 : speed;
...
Blockly.Arduino.wm_elf328p_encoder_motor_move = function() {
	var dropdown_pin = this.getFieldValue('PIN');
	var speed = Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
	speed	= speed > 255 ? 255 : speed;
  speed	= speed < -255 ? -255 : speed;
...
// Blockly.Arduino.wm_elf328p_stepper_motor_move = function() {
// 	var dropdown_pin = this.getFieldValue('PIN');
// 	var speed = Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
// 	speed	= speed > 255 ? 255 : speed;
//   speed	= speed < -255 ? -255 : speed;
...
// Blockly.Arduino.wm_elf328p_stepper_motor_moveTo = function() {
// 	var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_elf328p_ultrasonic_distance = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
Blockly.Arduino.wm_elf328p_ultrasonic_rgb = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_elf328p_ultrasonic_rgb_1 = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var index = this.getFieldValue('INDEX');
  var red = Blockly.Arduino.valueToCode(this, 'RED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var green = Blockly.Arduino.valueToCode(this, 'GREEN', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
...
Blockly.Arduino.wm_elf328p_ultrasonic_led = function() {
	var dropdown_pin = this.getFieldValue('PIN');
	var index = this.getFieldValue('INDEX');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//IR Avoid Sensor
Blockly.Arduino.wm_elf328p_ir_avoid_isObstacle = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
Blockly.Arduino.wm_elf328p_ir_avoid_rgb = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var index = this.getFieldValue('INDEX');
  var colour_rgb_led_color = this.getFieldValue('RGB_LED_COLOR');
  var color = goog.color.hexToRgb(colour_rgb_led_color);
...
Blockly.Arduino.wm_elf328p_ir_avoid_rgb_1 = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var index = this.getFieldValue('INDEX');
  var red = Blockly.Arduino.valueToCode(this, 'RED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var green = Blockly.Arduino.valueToCode(this, 'GREEN', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
...
Blockly.Arduino.wm_elf328p_ir_avoid_led = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var index = this.getFieldValue('INDEX');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
Blockly.Arduino.wm_elf328p_linefollower_sensor = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
Blockly.Arduino.wm_elf328p_single_linefollower_sensor = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//LED Panel Matrix
Blockly.Arduino.wm_elf328p_led_matrix_set_brightness = function() {
...
Blockly.Arduino.wm_elf328p_led_matrix_show_number = function() {
  var dropdown_type = this.getFieldValue('TYPE');
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_elf328p_led_matrix_show_clock = function() {
  var dropdown_type = this.getFieldValue('TYPE');
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_elf328p_led_matrix_show_string = function() {
  var dropdown_type = this.getFieldValue('TYPE');
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_elf328p_led_matrix_show_bitmap = function() {
  var dropdown_type = this.getFieldValue('TYPE');
  var dropdown_pin = this.getFieldValue('PIN');
  var x_axis = Blockly.Arduino.valueToCode(this, 'X_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
  var y_axis = Blockly.Arduino.valueToCode(this, 'Y_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
...
Blockly.Arduino.wm_elf328p_led_matrix_bitmap_5x14 = function() {
...
Blockly.Arduino.wm_elf328p_led_matrix_bitmap_7x21 = function() {
  var varName = this.getFieldValue('VAR');
  var a = new Array();
  for (var i = 0; i < 7; i++) {
    a[i] = new Array();
...
Blockly.Arduino.wm_elf328p_led_matrix_bitmap_default_514 = function() {
...
Blockly.Arduino.wm_elf328p_led_matrix_bitmap_default_721 = function() {
  var default_image = this.getFieldValue('DEFAULT_IMAGE');
  switch(default_image[10]){
...
Blockly.Arduino.wm_elf328p_led_matrix_show_pixel = function() {
  var dropdown_type = this.getFieldValue('TYPE');
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
  var x_axis = Blockly.Arduino.valueToCode(this, 'X_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
...
Blockly.Arduino.wm_elf328p_led_matrix_clear = function() {
  var dropdown_type = this.getFieldValue('TYPE');
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['led_matrix'+dropdown_pin] = 'WeLEDPanelModuleMatrix'+dropdown_type+' matrix_'+dropdown_type[0]+dropdown_type[2]+dropdown_type[3]+'_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
////4-Digtal LED Module
Blockly.Arduino.wm_elf328p_seven_segment_display_show_number = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var num = Blockly.Arduino.valueToCode(this, 'NUMBER', Blockly.Arduino.ORDER_ASSIGNMENT) || '100';
...
//OLED
Blockly.Arduino.wm_elf328p_oled_display_set_char_size = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_elf328p_oled_display_show_string = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var x_axis = Blockly.Arduino.valueToCode(this, 'X_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
  var y_axis = Blockly.Arduino.valueToCode(this, 'Y_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
...
Blockly.Arduino.wm_elf328p_oled_display_show_number = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var x_axis = Blockly.Arduino.valueToCode(this, 'X_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
  var y_axis = Blockly.Arduino.valueToCode(this, 'Y_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
...
Blockly.Arduino.wm_elf328p_oled_display_clear = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['oled'+dropdown_pin] = 'WeOLED oled_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
//MP3 Module
Blockly.Arduino.wm_elf328p_mp3_module_set_device = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
Blockly.Arduino.wm_elf328p_mp3_module_set_volume = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_elf328p_mp3_module_set_music = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_elf328p_mp3_module_play = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['mp3'+dropdown_pin] = 'WeMP3 mp3_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
Blockly.Arduino.wm_elf328p_mp3_module_pause = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['mp3'+dropdown_pin] = 'WeMP3 mp3_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
Blockly.Arduino.wm_elf328p_mp3_module_prev = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['mp3'+dropdown_pin] = 'WeMP3 mp3_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
Blockly.Arduino.wm_elf328p_mp3_module_next = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['mp3'+dropdown_pin] = 'WeMP3 mp3_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
Blockly.Arduino.wm_elf328p_mp3_module_music_is_over = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['mp3'+dropdown_pin] = 'WeMP3 mp3_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
//Relay Module
Blockly.Arduino.wm_elf328p_relay_module_set = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
Blockly.Arduino.wm_elf328p_water_atomizer_set = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
Blockly.Arduino.wm_elf328p_potentiometer_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
Blockly.Arduino.wm_elf328p_sliding_potentiometer_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//Joystick Module 
Blockly.Arduino.wm_elf328p_joystick_module_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//Touch Sensor
Blockly.Arduino.wm_elf328p_touch_sensor_set_mode = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_elf328p_touch_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['single_touch'+dropdown_pin] = 'WeTouchSensor single_touch_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
...
Blockly.Arduino.wm_elf328p_funny_touch_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//WeHumiture Sensor
Blockly.Arduino.wm_elf328p_humiture_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//Temperature Sensor
Blockly.Arduino.wm_elf328p_ds18b20_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//Tilt Switch Sensor
Blockly.Arduino.wm_elf328p_tilt_switch_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//Flame Sensor
Blockly.Arduino.wm_elf328p_flame_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//Gas Sensor
Blockly.Arduino.wm_elf328p_gas_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//PIR Sensor
Blockly.Arduino.wm_elf328p_pir_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//Color Sensor
Blockly.Arduino.wm_elf328p_color_sensor_set = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
Blockly.Arduino.wm_elf328p_color_sensor_wb = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['color_sensor'+dropdown_pin] = 'WeColorSensor color_sensor_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
...
Blockly.Arduino.wm_elf328p_color_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['color_sensor'+dropdown_pin] = 'WeColorSensor color_sensor_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
...
//Gyro Sensor
Blockly.Arduino.wm_elf328p_gyro_sensor_get_gyration = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
Blockly.Arduino.wm_elf328p_gyro_sensor_get_aacceleration = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['gyro_sensor'+dropdown_pin] = 'WeGyroSensor gyro_sensor_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
...
//Compass Sensor
Blockly.Arduino.wm_elf328p_compass_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//PM2.5 Sensor
Blockly.Arduino.wm_elf328p_pm25_sensor_set_mode = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_elf328p_pm25_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['pm25_sensor'+dropdown_pin] = 'WePM25Sensor pm25_sensor_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
...
Blockly.Arduino.wm_elf328p_pm25_sensor_get_value_1 = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
  Blockly.Arduino.definitions_['pm25_sensor'+dropdown_pin] = 'WePM25Sensor pm25_sensor_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
...
//Water Sensor
Blockly.Arduino.wm_elf328p_water_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//Barometer Sensor
Blockly.Arduino.wm_elf328p_barometer_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
...
//UV Sensor
Blockly.Arduino.wm_elf328p_uv_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['wm_elf328p_head'] = '#include <WeELF328P.h>';
