...
//Single LED Module
Blockly.Blocks.wm_elf328p_single_led = {
  init: function() {
...
Blockly.Blocks.wm_elf328p_buzzer_play_beat_ob = {
  init: function() {
...
Blockly.Blocks.wm_elf328p_buzzer_play_pitch_ob = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("蜂鸣器以频率");
...
Blockly.Blocks.wm_elf328p_sound_sensor = {
  init: function() {
...
Blockly.Blocks.wm_elf328p_light_sensor = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('光线传感器')
...
//RGB LED
Blockly.Blocks.wm_elf328p_rgb_on_board = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_elf328p_rgb_on_board_1 = {
    init: function () {
        this.setColour(WM_DISPLAY);
        this.appendDummyInput("")
            .appendField('板载单RGB灯显示')
...
Blockly.Blocks.wm_elf328p_rgb_ring = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('环形RGB灯模块');
    this.appendValueInput("PIXEL", Number)
        .setCheck(Number)
        .appendField("灯号(0~8,0为全部)");
    this.appendValueInput("RED", Number)
        .setCheck(Number)
        .appendField("显示红色");
    this.appendValueInput("GREEN", Number)
...
Blockly.Blocks.wm_elf328p_rgb_ring_1 = {
    init: function () {
        this.setColour(WM_DISPLAY);
        this.appendDummyInput("")
            .appendField('环形RGB灯模块');
...
Blockly.Blocks.wm_elf328p_rgb_rj = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_elf328p_rgb_rj_1 = {
    init: function () {
        this.setColour(WM_DISPLAY);
        this.appendDummyInput("")
            .appendField('RGBLED-5模块')
...
Blockly.Blocks.wm_elf328p_rgb_strip = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('RGB灯带')
...
Blockly.Blocks.wm_elf328p_rgb_strip_1 = {
    init: function () {
        this.setColour(WM_DISPLAY);
        this.appendDummyInput("")
            .appendField('RGB灯带')
...
Blockly.Blocks.wm_elf328p_ir_loop = {
  init: function() {
...
//Button
Blockly.Blocks.wm_elf328p_button_on_board = {
  init: function() {
...
Blockly.Blocks.wm_elf328p_button_rj = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_elf328p_button_rj_set_led = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
        .appendField("4位LED按键模块")
...
//Motor and Servo
Blockly.Blocks.wm_elf328p_dc_motors = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("直流电机接")
...
Blockly.Blocks.wm_elf328p_servos = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("舵机接")
...
Blockly.Blocks.wm_elf328p_130_dc_motor = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_elf328p_encoder_motor_run = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("编码电机接")
...
Blockly.Blocks.wm_elf328p_encoder_motor_runSpeed = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("编码电机接")
...
Blockly.Blocks.wm_elf328p_encoder_motor_move = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("编码电机接")
...
Blockly.Blocks.wm_elf328p_ultrasonic_distance = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('RGB超声波接')
...
Blockly.Blocks.wm_elf328p_ultrasonic_rgb = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('RGB超声波接')
...
Blockly.Blocks.wm_elf328p_ultrasonic_rgb_1 = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('RGB超声波接')
...
Blockly.Blocks.wm_elf328p_ultrasonic_led = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('RGB超声波接')
...
//IR Avoid Sensor
Blockly.Blocks.wm_elf328p_ir_avoid_isObstacle = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('红外避障传感器')
...
var WEEEMAKE_ULTRASONIC_RGB=[["全部","3"],["左边","2"],["右边","1"]];
Blockly.Blocks.wm_elf328p_ir_avoid_rgb = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('红外避障传感器')
...
Blockly.Blocks.wm_elf328p_ir_avoid_rgb_1 = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('红外避障传感器')
...
Blockly.Blocks.wm_elf328p_ir_avoid_led = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('红外避障传感器')
...
Blockly.Blocks.wm_elf328p_linefollower_sensor = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
var WEEEMAKE_ANALOG_PORTS =[["PORT_1", "PORT_1"],["PORT_2", "PORT_2"],["PORT_3", "PORT_3"],["PORT_4", "PORT_4"],["PORT_5", "PORT_5"],["PORT_6", "PORT_6"]];
Blockly.Blocks.wm_elf328p_single_linefollower_sensor = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('单路巡线传感器接')
        .appendField(new Blockly.FieldDropdown(WEEEMAKE_ANALOG_PORTS), "PIN")
        .appendField('读取值');
    this.setInputsInline(true);
    this.setOutput(true, Number);
    this.setTooltip('');
...
// Blockly.Blocks.wm_elf328p_led_linefollower_sensor = {
//   init: function() {
//     this.setColour(WM_SENSOR);
//     this.appendDummyInput("")
...
Blockly.Blocks.wm_elf328p_led_matrix_show_number = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
Blockly.Blocks.wm_elf328p_led_matrix_show_clock = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
Blockly.Blocks.wm_elf328p_led_matrix_show_string = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
Blockly.Blocks.wm_elf328p_led_matrix_show_bitmap = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
Blockly.Blocks.wm_elf328p_led_matrix_bitmap_5x14 = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField("创建名为")
...
Blockly.Blocks.wm_elf328p_led_matrix_bitmap_7x21 = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField("创建名为")
...
Blockly.Blocks.wm_elf328p_led_matrix_bitmap_default_514 = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_elf328p_led_matrix_bitmap_default_721 = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_elf328p_led_matrix_clear = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
Blockly.Blocks.wm_elf328p_led_matrix_show_pixel = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
Blockly.Blocks.wm_elf328p_led_matrix_set_brightness = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
//4-Digtal LED Module
Blockly.Blocks.wm_elf328p_seven_segment_display_show_number = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
...
//OLED Module
Blockly.Blocks.wm_elf328p_oled_display_set_char_size = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_elf328p_oled_display_show_string = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('OLED显示屏接')
...
Blockly.Blocks.wm_elf328p_oled_display_show_number = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('OLED显示屏接')
...
Blockly.Blocks.wm_elf328p_oled_display_clear = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField("OLED显示屏接")
...
//MP3 Module
Blockly.Blocks.wm_elf328p_mp3_module_set_device = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_elf328p_mp3_module_set_volume = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_elf328p_mp3_module_set_music = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_elf328p_mp3_module_play = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_elf328p_mp3_module_pause = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_elf328p_mp3_module_prev = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_elf328p_mp3_module_next = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_elf328p_mp3_module_music_is_over = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField('MP3模块接')
...
//Relay Module
Blockly.Blocks.wm_elf328p_relay_module_set = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("继电器模块接")
...
Blockly.Blocks.wm_elf328p_water_atomizer_set = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("雾化器模块接")
...
Blockly.Blocks.wm_elf328p_potentiometer_get_value = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
        .appendField('旋转电位器接')
...
Blockly.Blocks.wm_elf328p_sliding_potentiometer_get_value = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
        .appendField('滑动电位器接')
...
//Joystick Module 
Blockly.Blocks.wm_elf328p_joystick_module_get_value = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
        .appendField('全向摇杆接')
...
//Touch Sensor
Blockly.Blocks.wm_elf328p_touch_sensor_set_mode = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_elf328p_touch_sensor_get_value = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
        .appendField('单路触摸传感器接')
...
Blockly.Blocks.wm_elf328p_funny_touch_sensor_get_value = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
...
//WeHumiture Sensor
Blockly.Blocks.wm_elf328p_humiture_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('温湿度传感器接')
...
//Temperature Sensor
Blockly.Blocks.wm_elf328p_ds18b20_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
//Tilt Switch Sensor
Blockly.Blocks.wm_elf328p_tilt_switch_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
//Flame Sensor
Blockly.Blocks.wm_elf328p_flame_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('火焰传感器接')
...
//Gas Sensor
Blockly.Blocks.wm_elf328p_gas_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
//PIR Sensor
Blockly.Blocks.wm_elf328p_pir_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
//Color Sensor
Blockly.Blocks.wm_elf328p_color_sensor_set = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_elf328p_color_sensor_wb = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField("颜色识别传感器接")
...
Blockly.Blocks.wm_elf328p_color_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('颜色识别传感器接')
...
//Gyro Sensor
Blockly.Blocks.wm_elf328p_gyro_sensor_get_gyration = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('陀螺仪接')
...
Blockly.Blocks.wm_elf328p_gyro_sensor_get_aacceleration = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('陀螺仪接')
...
//Compass Sensor
Blockly.Blocks.wm_elf328p_compass_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('电子罗盘接')
...
//PM2.5 Sensor
Blockly.Blocks.wm_elf328p_pm25_sensor_set_mode = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_elf328p_pm25_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('PM2.5传感器接')
...
Blockly.Blocks.wm_elf328p_pm25_sensor_get_value_1 = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('PM2.5传感器接')
...
//Water Sensor
Blockly.Blocks.wm_elf328p_water_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('雨滴传感器接')
...
//Barometer Sensor
Blockly.Blocks.wm_elf328p_barometer_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('气压传感器接')
...
//UV Sensor
Blockly.Blocks.wm_elf328p_uv_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('紫外线传感器接')
