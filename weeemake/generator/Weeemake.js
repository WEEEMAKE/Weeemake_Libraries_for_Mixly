...
Blockly.Arduino.wm_main_control_board_directions = function() {
  var code = '';
  return code;
};

Blockly.Arduino.wm_main_control_board = function() {
  var dropdown_board_type = this.getFieldValue('Board_Type');
  switch(dropdown_board_type){
  		case '1':Blockly.Arduino.definitions_['define_weeemake'] = '#include <WeELF328P.h>';break;
  		case '2':Blockly.Arduino.definitions_['define_weeemake'] = '#include <WeELF2560.h>';break;
  		case '3':Blockly.Arduino.definitions_['define_weeemake'] = '#include <WeELFMini.h>';break;
  }
  var code = '\n';
  return code;
};
...
//
Blockly.Arduino.wm_single_led = function() {
...
//Buzzer
Blockly.Arduino.wm_buzzer_play_beat_ob = function() {
  var dropdown_tone = this.getFieldValue('TONE');
  var dropdown_beat = this.getFieldValue('BEAT');
  Blockly.Arduino.definitions_['var_buzzer'] = 'WeBuzzer buzzer_OB(OnBoard_Buzzer);';
  var code = 'buzzer_OB.tone('+dropdown_tone+','+dropdown_beat+');\n';
  return code;
};

Blockly.Arduino.wm_buzzer_play_pitch_ob = function() {
...
//Sound Sensor
Blockly.Arduino.wm_sound_sensor = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['sound_sensor'+dropdown_pin] = 'WeSoundSensor sound_sensor_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
  var code = 'sound_sensor_'+dropdown_pin[5]+'.read()';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.wm_sound_sensor_for_mini = function() {
  Blockly.Arduino.definitions_['sound_sensor_for_mini'] = 'WeSoundSensor sound_sensor_OB(OnBoard_Sound);'
  var code = 'sound_sensor_OB.read()';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

//Sound Sensor
Blockly.Arduino.wm_light_sensor = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['light_sensor'+dropdown_pin] = 'WeLightSensor light_sensor_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
  var code = 'light_sensor_'+dropdown_pin[5]+'.read()';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.wm_light_sensor_for_mini = function() {
  Blockly.Arduino.definitions_['light_sensor_for_mini'] = 'WeLightSensor light_sensor_OB(OnBoard_Light);'
  var code = 'light_sensor_OB.read()';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

//IR Sensor
Blockly.Arduino.wm_ir_loop = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['ir'+dropdown_pin] = 'WeInfraredReceiver ir_'+dropdown_pin[5]+'('+dropdown_pin+');'
  Blockly.Arduino.setups_['ir_setup'+dropdown_pin] = 'ir_'+dropdown_pin[5]+'.begin();'
  var code = 'ir_'+dropdown_pin[5]+'.loop();\n'
  return code;
};

Blockly.Arduino.wm_ir = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_key_table = this.getFieldValue('KEY_TABLE');
  Blockly.Arduino.definitions_['ir'+dropdown_pin] = 'WeInfraredReceiver ir_'+dropdown_pin[5]+'('+dropdown_pin+');'
  // Blockly.Arduino.setups_['ir_setup'+dropdown_pin] = 'IR_P'+dropdown_pin[5]+'.begin();'
  var code = 'ir_'+dropdown_pin[5]+'.isKeyPressed('+dropdown_key_table+')';
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.wm_ir_on_board_for_mini_loop = function() {
  var dropdown_key_table = this.getFieldValue('KEY_TABLE');
  Blockly.Arduino.definitions_['ir_on_board_for_mini'] = 'WeInfraredReceiver ir_OB(OnBoard_IR);'
  Blockly.Arduino.setups_['ir_on_board_for_mini_setup'] = 'ir_OB.begin();'
  var code = 'ir_OB.loop();\n'
  return code;
};

Blockly.Arduino.wm_ir_on_board_for_mini = function() {
  var dropdown_key_table = this.getFieldValue('KEY_TABLE');
  Blockly.Arduino.definitions_['ir_on_board_for_mini'] = 'WeInfraredReceiver ir_ob(OnBoard_IR);'
  // Blockly.Arduino.setups_['ir_on_board_for_mini_setup'] = 'ir_ob.begin();'
...
//RGB LED
Blockly.Arduino.wm_rgb_on_board = function() {
...
Blockly.Arduino.wm_rgb_on_board_1 = function() {
...
Blockly.Arduino.wm_rgb_ring = function() {
  ...
  var code = 'rgb_ring.setColor('+pixel+','+red+','+green+','+blue+');\n'+'rgb_ring.show();\n';
  return code;
};

Blockly.Arduino.wm_rgb_ring_1 = function() {
  var pixel = Blockly.Arduino.valueToCode(this, 'PIXEL', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var colour_rgb_led_color = this.getFieldValue('RGB_LED_COLOR');
  var color = goog.color.hexToRgb(colour_rgb_led_color);
  Blockly.Arduino.definitions_['rgb_ring'] = 'WeRGBLed rgb_RING(13);';
  var code = 'rgb_RING.setColor('+pixel+','+color+');\n'+'rgb_RING.show();\n';
  return code;
};

Blockly.Arduino.wm_rgb_rj = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var pixel = Blockly.Arduino.valueToCode(this, 'PIXEL', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var red = Blockly.Arduino.valueToCode(this, 'RED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var green = Blockly.Arduino.valueToCode(this, 'GREEN', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
...
Blockly.Arduino.wm_rgb_rj_1 = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var pixel = Blockly.Arduino.valueToCode(this, 'PIXEL', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var colour_rgb_led_color = this.getFieldValue('RGB_LED_COLOR');
  var color = goog.color.hexToRgb(colour_rgb_led_color);
...
Blockly.Arduino.wm_rgb_strip = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var pixel = Blockly.Arduino.valueToCode(this, 'PIXEL', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var red = Blockly.Arduino.valueToCode(this, 'RED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var green = Blockly.Arduino.valueToCode(this, 'GREEN', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
...
Blockly.Arduino.wm_rgb_strip_1 = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var pixel = Blockly.Arduino.valueToCode(this, 'PIXEL', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var colour_rgb_led_color = this.getFieldValue('RGB_LED_COLOR');
  var color = goog.color.hexToRgb(colour_rgb_led_color);
...
//Button
Blockly.Arduino.wm_button_on_board = function() {
  Blockly.Arduino.definitions_['button_on_board'] = 'WeButton button_OB(OnBoard_Button);'
  var code = 'button_OB.read()==0'
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.wm_button_rj = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['button_rj'+dropdown_pin] = 'We4LEDButton button4_'+dropdown_pin[5]+'('+dropdown_pin+');';
  var code = 'button4_P'+dropdown_pin[5]+'.read()=='+dropdown_index
  return [code, Blockly.Arduino.ORDER_ATOMIC];
};

Blockly.Arduino.wm_button_rj_set_led = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Arduino.definitions_['button_rj'+dropdown_pin] = 'We4LEDButton button4_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
//Motor and Servo
Blockly.Arduino.wm_dc_motors = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_servos = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  ...
  Blockly.Arduino.definitions_['wm_servos'+dropdown_pin] = 'Servo servo_'+dropdown_pin[5]+';';
  Blockly.Arduino.setups_['wm_servos_setup'+dropdown_pin] = 'servo_'+dropdown_pin[5]+'.attach('+dropdown_pin+');';
  var code = 'servo_'+dropdown_pin[5]+'.write('+degree+');\n';
  return code;
};


Blockly.Arduino.wm_130_dc_motor = function() {
	var dropdown_pin = this.getFieldValue('PIN');
	var speed = Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
	speed	= speed > 255 ? 255 : speed;
  speed	= speed < -255 ? -255 : speed;
	Blockly.Arduino.definitions_['wm_130_dc_motor'+dropdown_pin] = 'We130DCMotor motor130_'+dropdown_pin[5]+'('+dropdown_pin+');';
	var code = 'motor130_'+dropdown_pin[5]+'.run('+speed+');\n';
	return code;
};

Blockly.Arduino.wm_encoder_motor_run = function() {
	var dropdown_pin = this.getFieldValue('PIN');
	var speed = Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
	speed	= speed > 255 ? 255 : speed;
  speed	= speed < -255 ? -255 : speed;
	Blockly.Arduino.definitions_['encoder_motor'+dropdown_pin] = 'WeEncoderMotor encodermotor_'+dropdown_pin[5]+'('+dropdown_pin+');';
	var code = 'encodermotor_'+dropdown_pin[5]+'.run('+speed+');\n';
	return code;
};

Blockly.Arduino.wm_encoder_motor_runSpeed = function() {
	var dropdown_pin = this.getFieldValue('PIN');
	var speed = Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
	speed	= speed > 255 ? 255 : speed;
  speed	= speed < -255 ? -255 : speed;
	Blockly.Arduino.definitions_['encoder_motor'+dropdown_pin] = 'WeEncoderMotor encodermotor_'+dropdown_pin[5]+'('+dropdown_pin+');';
	var code = 'encodermotor_'+dropdown_pin[5]+'.runSpeed('+speed+');\n';
	return code;
};

Blockly.Arduino.wm_encoder_motor_move = function() {
	var dropdown_pin = this.getFieldValue('PIN');
	var speed = Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
	speed	= speed > 255 ? 255 : speed;
  speed	= speed < -255 ? -255 : speed;
  var position = Blockly.Arduino.valueToCode(this, 'POSITION', Blockly.Arduino.ORDER_ASSIGNMENT) || '100';
	Blockly.Arduino.definitions_['encoder_motor'+dropdown_pin] = 'WeEncoderMotor encodermotor_'+dropdown_pin[5]+'('+dropdown_pin+');';
	var code = 'encodermotor_'+dropdown_pin[5]+'.move('+speed+','+position+');\n';
	return code;
};

// Blockly.Arduino.wm_stepper_motor_move = function() {
// 	var dropdown_pin = this.getFieldValue('PIN');
// 	var speed = Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
// 	speed	= speed > 255 ? 255 : speed;
//   speed	= speed < -255 ? -255 : speed;
// 	Blockly.Arduino.definitions_['stepper_motor'+dropdown_pin] = 'WeStepperMotor steppermotor_'+dropdown_pin[5]+'('+dropdown_pin+');';
// 	var code = 'steppermotor_'+dropdown_pin[5]+'.runSpeed('+speed+');\n';
// 	return code;
// };

// Blockly.Arduino.wm_stepper_motor_moveTo = function() {
// 	var dropdown_pin = this.getFieldValue('PIN');
// 	var micro_step = this.getFieldValue('MICRO_STEP');
// 	var speed = Blockly.Arduino.valueToCode(this, 'SPEED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
// 	speed	= speed > 254 ? 254 : speed;
//   speed	= speed < -0 ? 0 : speed;
//   var position = Blockly.Arduino.valueToCode(this, 'POSITION', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
// 	Blockly.Arduino.definitions_['stepper_motor'+dropdown_pin] = 'WeStepperMotor steppermotor_'+dropdown_pin[5]+'('+dropdown_pin+');';
// 	Blockly.Arduino.setups_['stepper_motor_setup1'+dropdown_pin] = 'steppermotor_'+dropdown_pin[5]+'.setMicroStep('+micro_step+');';
// 	Blockly.Arduino.setups_['stepper_motor_setup2'+dropdown_pin] = 'steppermotor_'+dropdown_pin[5]+'.setSpeed('+speed+');';
// 	var code = 'steppermotor_'+dropdown_pin[5]+'.moveTo('+position+');\n';
// 	return code;
// };

//RGB Ultrasonic Sensor
Blockly.Arduino.wm_ultrasonic_distance = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_ultrasonic_rgb = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_ultrasonic_rgb_1 = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var index = this.getFieldValue('INDEX');
  var red = Blockly.Arduino.valueToCode(this, 'RED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var green = Blockly.Arduino.valueToCode(this, 'GREEN', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
...
Blockly.Arduino.wm_ultrasonic_led = function() {
	var dropdown_pin = this.getFieldValue('PIN');
	var index = this.getFieldValue('INDEX');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Arduino.definitions_['ultrasonic'+dropdown_pin] = 'WeUltrasonicSensor ultrasonic_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
//IR Avoid Sensor
Blockly.Arduino.wm_ir_avoid_isObstacle = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_ir_avoid_rgb = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var index = this.getFieldValue('INDEX');
  var colour_rgb_led_color = this.getFieldValue('RGB_LED_COLOR');
  var color = goog.color.hexToRgb(colour_rgb_led_color);
...
Blockly.Arduino.wm_ir_avoid_rgb_1 = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var index = this.getFieldValue('INDEX');
  var red = Blockly.Arduino.valueToCode(this, 'RED', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
  var green = Blockly.Arduino.valueToCode(this, 'GREEN', Blockly.Arduino.ORDER_ASSIGNMENT) || '0';
...
Blockly.Arduino.wm_ir_avoid_led = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var index = this.getFieldValue('INDEX');
  var dropdown_stat = this.getFieldValue('STAT');
  Blockly.Arduino.definitions_['ir_avoid'+dropdown_pin] = 'WeIRAvoidSensor ir_avoid_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
Blockly.Arduino.wm_linefollower_sensor = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var index = this.getFieldValue('INDEX');
...
Blockly.Arduino.wm_single_linefollower_sensor = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
//LED Panel Matrix
Blockly.Arduino.wm_led_matrix_set_brightness = function() {
...
Blockly.Arduino.wm_led_matrix_show_number = function() {
  var dropdown_type = this.getFieldValue('TYPE');
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_led_matrix_show_clock = function() {
  var dropdown_type = this.getFieldValue('TYPE');
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_led_matrix_show_string = function() {
  var dropdown_type = this.getFieldValue('TYPE');
  var dropdown_pin = this.getFieldValue('PIN');
  ...
  // var text = "WMZX";
  Blockly.Arduino.definitions_['led_matrix'+dropdown_pin] = 'WeLEDPanelModuleMatrix'+dropdown_type+' matrix_'+dropdown_type[0]+dropdown_type[2]+dropdown_type[3]+'_'+dropdown_pin[5]+'('+dropdown_pin+');';
  var code = 'matrix_'+dropdown_type[0]+dropdown_type[2]+dropdown_type[3]+'_'+dropdown_pin[5]+'.showString('+x_axis+','+y_axis+','+text+');\n';
  return code;
};

Blockly.Arduino.wm_led_matrix_show_bitmap = function() {
  var dropdown_type = this.getFieldValue('TYPE');
  var dropdown_pin = this.getFieldValue('PIN');
  var x_axis = Blockly.Arduino.valueToCode(this, 'X_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
  var y_axis = Blockly.Arduino.valueToCode(this, 'Y_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
...
Blockly.Arduino.wm_led_matrix_bitmap_5x14 = function() {
...
Blockly.Arduino.wm_led_matrix_bitmap_7x21 = function() {
  var varName = this.getFieldValue('VAR');
  var a = new Array();
  for (var i = 0; i < 7; i++) {
    a[i] = new Array();
...
Blockly.Arduino.wm_led_matrix_bitmap_default_514 = function() {
...
Blockly.Arduino.wm_led_matrix_bitmap_default_721 = function() {
  var default_image = this.getFieldValue('DEFAULT_IMAGE');
  switch(default_image[10]){
...
Blockly.Arduino.wm_led_matrix_show_pixel = function() {
  var dropdown_type = this.getFieldValue('TYPE');
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
  var x_axis = Blockly.Arduino.valueToCode(this, 'X_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
...
Blockly.Arduino.wm_led_matrix_clear = function() {
  var dropdown_type = this.getFieldValue('TYPE');
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['led_matrix'+dropdown_pin] = 'WeLEDPanelModuleMatrix'+dropdown_type+' matrix_'+dropdown_type[0]+dropdown_type[2]+dropdown_type[3]+'_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
////4-Digtal LED Module
Blockly.Arduino.wm_seven_segment_display_show_number = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var num = Blockly.Arduino.valueToCode(this, 'NUMBER', Blockly.Arduino.ORDER_ASSIGNMENT) || '100';
...
//OLED
Blockly.Arduino.wm_oled_display_set_char_size = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_oled_display_show_string = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var x_axis = Blockly.Arduino.valueToCode(this, 'X_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
  var y_axis = Blockly.Arduino.valueToCode(this, 'Y_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
...
Blockly.Arduino.wm_oled_display_show_number = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var x_axis = Blockly.Arduino.valueToCode(this, 'X_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
  var y_axis = Blockly.Arduino.valueToCode(this, 'Y_AXIS', Blockly.Arduino.ORDER_ATOMIC) || '0';
...
Blockly.Arduino.wm_oled_display_clear = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['oled'+dropdown_pin] = 'WeOLED oled_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
//MP3 Module
Blockly.Arduino.wm_mp3_module_set_device = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var index = this.getFieldValue('INDEX');
...
Blockly.Arduino.wm_mp3_module_set_volume = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_mp3_module_set_music = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_mp3_module_play = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['mp3'+dropdown_pin] = 'WeMP3 mp3_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
Blockly.Arduino.wm_mp3_module_pause = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['mp3'+dropdown_pin] = 'WeMP3 mp3_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
Blockly.Arduino.wm_mp3_module_prev = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['mp3'+dropdown_pin] = 'WeMP3 mp3_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
Blockly.Arduino.wm_mp3_module_next = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['mp3'+dropdown_pin] = 'WeMP3 mp3_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
Blockly.Arduino.wm_mp3_module_music_is_over = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['mp3'+dropdown_pin] = 'WeMP3 mp3_'+dropdown_pin[5]+'('+dropdown_pin+');';
...
//Relay Module
Blockly.Arduino.wm_relay_module_set = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
...
Blockly.Arduino.wm_water_atomizer_set = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
...
Blockly.Arduino.wm_potentiometer_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_sliding_potentiometer_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
//Joystick Module 
Blockly.Arduino.wm_joystick_module_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
...
//Touch Sensor
Blockly.Arduino.wm_touch_sensor_set_mode = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_touch_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['single_touch'+dropdown_pin] = 'WeTouchSensor single_touch_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
...
Blockly.Arduino.wm_funny_touch_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
//WeHumiture Sensor
Blockly.Arduino.wm_humiture_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
...
//Temperature Sensor
Blockly.Arduino.wm_ds18b20_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
//Tilt Switch Sensor
Blockly.Arduino.wm_tilt_switch_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
//Flame Sensor
Blockly.Arduino.wm_flame_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
...
//Gas Sensor
Blockly.Arduino.wm_gas_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
//PIR Sensor
Blockly.Arduino.wm_pir_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
//Color Sensor
Blockly.Arduino.wm_color_sensor_set = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_stat = this.getFieldValue('STAT');
...
Blockly.Arduino.wm_color_sensor_wb = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  Blockly.Arduino.definitions_['color_sensor'+dropdown_pin] = 'WeColorSensor color_sensor_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
...
Blockly.Arduino.wm_color_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['color_sensor'+dropdown_pin] = 'WeColorSensor color_sensor_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
...
//Gyro Sensor
Blockly.Arduino.wm_gyro_sensor_get_gyration = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
...
Blockly.Arduino.wm_gyro_sensor_get_aacceleration = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['gyro_sensor'+dropdown_pin] = 'WeGyroSensor gyro_sensor_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
...
//Compass Sensor
Blockly.Arduino.wm_compass_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
...
//PM2.5 Sensor
Blockly.Arduino.wm_pm25_sensor_set_mode = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
Blockly.Arduino.wm_pm25_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['pm25_sensor'+dropdown_pin] = 'WePM25Sensor pm25_sensor_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
...
Blockly.Arduino.wm_pm25_sensor_get_value_1 = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['pm25_sensor'+dropdown_pin] = 'WePM25Sensor pm25_sensor_'+dropdown_pin[5]+'('+dropdown_pin+')'+';';
  var code = 'pm25_sensor_'+dropdown_pin[5]+dropdown_index;
...
//Water Sensor
Blockly.Arduino.wm_water_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
//Barometer Sensor
Blockly.Arduino.wm_barometer_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
...
//UV Sensor
Blockly.Arduino.wm_uv_sensor_get_value = function() {
  var dropdown_pin = this.getFieldValue('PIN');
  var dropdown_index = this.getFieldValue('INDEX');
  Blockly.Arduino.definitions_['uv_sensor'+dropdown_pin] = 'WeBarometerSensor uv_sensor_'+dropdown_pin[5]+'('+dropdown_pin+');';
