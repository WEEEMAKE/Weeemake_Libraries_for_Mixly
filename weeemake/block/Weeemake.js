...
// var WEEEMAKE_PORTS =[["PORT_A", "PORT_A"],["PORT_B", "PORT_B"],["PORT_C", "PORT_C"],["PORT_D", "PORT_D"],["PORT_1", "PORT_1"],["PORT_2", "PORT_2"],["PORT_3", "PORT_3"],["PORT_4", "PORT_4"],["PORT_5", "PORT_5"],["PORT_6", "PORT_6"]];
var WEEEMAKE_PORTS =[["PORT_A", "PORT_A"],["PORT_B", "PORT_B"],["PORT_C", "PORT_C"],["PORT_D", "PORT_D"],["PORT_E", "PORT_1"],["PORT_F", "PORT_2"],["PORT_G", "PORT_3"],["PORT_H", "PORT_4"]];

var WEEEMAKE_MOTORS=[["M1", "M1"],["M2", "M2"],["M3", "M3"],["M4", "M4"],["M5", "M5"],["M6", "M6"],["M7", "M7"],["M8", "M8"],["M9", "M9"],["M10", "M10"]];
var WEEEMAKE_SLOTS=[["SLOT1", "1"],["SLOT2", "2"]];
var WEEEMAKE_UNIT=[["cm", "Cm"],["inch", "Inch"]];
var WEEEMAKE_ISON=[["On", "On"],["Off", "Off"]];

Blockly.Blocks.wm_main_control_board_directions = {
  init: function() {
    this.setColour(Blockly.Blocks.weeemake.HUE);
    this.appendDummyInput("")
        .appendTitle('说明1：ELF_MINI系列小型主控板的端口仅限于<A,B,C,D>');
    this.appendDummyInput("")
        .appendTitle('      4个选项,其均为模拟口;');
    this.appendDummyInput("")
        .appendField('说明2：ELF_MAGA-328等所使用的大型主控板<A,B,C,D>4个端口')
    this.appendDummyInput("")
        .appendField('      为数字口,<1-6>口为模拟口;');
    this.appendDummyInput("")
        .appendField('说明3：使用该库前，请对Weeemake电子平台的主控板及电子模块');
    this.appendDummyInput("")
        .appendField('      进行了解，以便更好地对其进行编程;');
    this.appendDummyInput("")
        .appendField('说明4：编程时，请务必根据所使用的主控板类型,加入下面的块。');
...
Blockly.Blocks.wm_main_control_board = {
  init: function() {
    this.setColour(Blockly.Blocks.weeemake.HUE);
    this.appendDummyInput("")
        .appendField(Blockly.WEEEMAKE_MAIN_CONTROL_BOARD)
        .appendField(new Blockly.FieldDropdown(WEEEMAKE_MAIN_CONTROL_BOARD), "Board_Type")
    this.setPreviousStatement(false, null);
    this.setNextStatement(false, null);
    this.setTooltip(Blockly.WEEEMAKE_MAIN_CONTROL_BOARD_TOOLTIP);
    this.setHelpUrl('https://www.weeemake.com.cn/wiki/doku.php?id=wm_wiki:elf%E4%B8%BB%E6%8E%A7%E6%9D%BF');
  }
};

//Single LED
Blockly.Blocks.wm_single_led = {
  init: function() {
...
Blockly.Blocks.wm_elfmini_led_on_board = {
  init: function() {
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip("此语句块仅适用于ELF MINI主控板板载单色LED灯");
  }
};
...
Blockly.Blocks.wm_buzzer_play_beat_ob = {
  init: function() {
...
Blockly.Blocks.wm_buzzer_play_pitch_ob = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("蜂鸣器以频率");
...
//Sound Sensor
var WEEEMAKE_SOUND_PORTS =[["PORT_1", "PORT_1"],["PORT_2", "PORT_2"],["PORT_3", "PORT_3"],["PORT_4", "PORT_4"],["PORT_5", "PORT_5"],["PORT_6", "PORT_6"]];
Blockly.Blocks.wm_sound_sensor = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('声音传感器')
        .appendField(new Blockly.FieldDropdown(WEEEMAKE_SOUND_PORTS), "PIN")
        .appendField('读值');
    this.setInputsInline(true);
...
Blockly.Blocks.wm_sound_sensor_for_mini = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('ELF MINI板载声音传感器读值');
    this.setInputsInline(true);
    this.setOutput(true, Number);
    this.setTooltip('');
  }
...
//Light Sensor
var WEEEMAKE_LIGHT_PORTS =[["PORT_1", "PORT_1"],["PORT_2", "PORT_2"],["PORT_3", "PORT_3"],["PORT_4", "PORT_4"],["PORT_5", "PORT_5"],["PORT_6", "PORT_6"]];

Blockly.Blocks.wm_light_sensor = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('光线传感器')
        .appendField(new Blockly.FieldDropdown(WEEEMAKE_LIGHT_PORTS), "PIN")
        .appendField('读值');
    this.setInputsInline(true);
    this.setOutput(true, Number);
    this.setTooltip('');
...
Blockly.Blocks.wm_light_sensor_for_mini = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('ELF MINI主控板载光线传感器读值');
    this.setOutput(true, Number);
    this.setTooltip('');
  }
}
...
//RGB LED
Blockly.Blocks.wm_rgb_on_board = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('板载单RGB灯显示')
...
Blockly.Blocks.wm_rgb_on_board_1 = {
    init: function () {
        this.setColour(WM_DISPLAY);
        this.appendDummyInput("")
            .appendField('板载单RGB灯显示')
...
Blockly.Blocks.wm_rgb_ring = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('环形RGB灯模块显示');
...
Blockly.Blocks.wm_ir_loop = {
  init: function() {
    this.setColour(WM_COMMUNICATION);
    this.appendDummyInput("")
        .appendField('红外接收模块')
        .appendField(new Blockly.FieldDropdown(WEEEMAKE_IR_PORTS), "PIN")
        .appendField('对红外遥控按键扫描');
    this.setInputsInline(true);
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
  }
...
Blockly.Blocks.wm_ir_on_board_for_mini_loop = {
  init: function() {
    this.setColour(WM_COMMUNICATION);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_ir_on_board_for_mini = {
  init: function() {
    this.setColour(WM_COMMUNICATION);
    this.appendDummyInput("")
...
//Button
Blockly.Blocks.wm_button_on_board = {
  init: function() {
...
Blockly.Blocks.wm_button_rj_set_led = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
        .appendField("4位LED按键模块")
...
Blockly.Blocks.wm_130_dc_motor = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
...
var WEEEMAKE_ENCODER_MOTOR_PORTS = [["PORT_3","PORT_3"],["PORT_4","PORT_4"],["PORT_5","PORT_5"],["PORT_6","PORT_6"]];
Blockly.Blocks.wm_encoder_motor_run = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("编码电机接")
...
Blockly.Blocks.wm_encoder_motor_runSpeed = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("编码电机接")
...
Blockly.Blocks.wm_encoder_motor_move = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("编码电机接")
...
// Blockly.Blocks.wm_stepper_motor_move = {
//   init: function() {
//     this.setColour(WM_EXECUTION);
//     this.appendDummyInput("")
//         .appendField("步进电机接")
...
// var WEEEMAKE_STEPPER_MOTOR_MICRO_STEP=[["1","1"],["2","2"],["4","4"],["8","8"],["16","16"],["32","32"]];
// Blockly.Blocks.wm_stepper_motor_moveTo = {
//   init: function() {
//     this.setColour(WM_EXECUTION);
//     this.appendDummyInput("")
//         .appendField("步进电机接")
//         .appendField(new Blockly.FieldDropdown(WEEEMAKE_ENCODER_MOTOR_PORTS), "PIN")
//         .appendField("设置微步为")
//         .appendField(new Blockly.FieldDropdown(WEEEMAKE_STEPPER_MOTOR_MICRO_STEP), "MICRO_STEP");
//     this.appendValueInput("SPEED")
//         .appendField("设置速度为")
//         .setCheck(Number);
//     this.appendValueInput("POSITION")
...
Blockly.Blocks.wm_ultrasonic_distance = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('RGB超声波接')
...
Blockly.Blocks.wm_ultrasonic_rgb = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('RGB超声波接')
...
Blockly.Blocks.wm_ultrasonic_rgb_1 = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('RGB超声波接')
...
Blockly.Blocks.wm_ultrasonic_led = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('RGB超声波接')
...
//IR Avoid Sensor
Blockly.Blocks.wm_ir_avoid_isObstacle = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('红外避障传感器')
...
var WEEEMAKE_ULTRASONIC_RGB=[["全部","3"],["左边","2"],["右边","1"]];
Blockly.Blocks.wm_ir_avoid_rgb = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('红外避障传感器')
...
Blockly.Blocks.wm_ir_avoid_rgb_1 = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('红外避障传感器')
...
Blockly.Blocks.wm_ir_avoid_led = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('红外避障传感器')
...
Blockly.Blocks.wm_linefollower_sensor = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_single_linefollower_sensor = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        ...
        .appendField('读取值');
    this.appendDummyInput("")
        .appendField('(该模块需用模拟接口,如用ELF_MINI请选A-D,否则请选1-6)');
    this.setInputsInline(true);
    this.setOutput(true, Number);
    this.setTooltip('');
  }
...
// Blockly.Blocks.wm_led_linefollower_sensor = {
//   init: function() {
//     this.setColour(WM_SENSOR);
//     this.appendDummyInput("")
...
Blockly.Blocks.wm_led_matrix_show_number = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
Blockly.Blocks.wm_led_matrix_show_clock = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
Blockly.Blocks.wm_led_matrix_show_string = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
Blockly.Blocks.wm_led_matrix_show_bitmap = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
Blockly.Blocks.wm_led_matrix_bitmap_5x14 = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField("创建名为")
...
Blockly.Blocks.wm_led_matrix_bitmap_7x21 = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField("创建名为")
...
Blockly.Blocks.wm_led_matrix_bitmap_default_514 = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_led_matrix_bitmap_default_721 = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_led_matrix_clear = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
Blockly.Blocks.wm_led_matrix_show_pixel = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
Blockly.Blocks.wm_led_matrix_set_brightness = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('LED点阵屏')
...
//4-Digtal LED Module
Blockly.Blocks.wm_seven_segment_display_show_number = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
...
//OLED Module
Blockly.Blocks.wm_oled_display_set_char_size = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_oled_display_show_string = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('OLED显示屏接')
...
Blockly.Blocks.wm_oled_display_show_number = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField('OLED显示屏接')
...
Blockly.Blocks.wm_oled_display_clear = {
  init: function() {
    this.setColour(WM_DISPLAY);
    this.appendDummyInput("")
        .appendField("OLED显示屏接")
...
//MP3 Module
Blockly.Blocks.wm_mp3_module_set_device = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_mp3_module_set_volume = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_mp3_module_set_music = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_mp3_module_play = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_mp3_module_pause = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_mp3_module_prev = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_mp3_module_next = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("MP3模块接")
...
Blockly.Blocks.wm_mp3_module_music_is_over = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField('MP3模块接')
...
//Relay Module
Blockly.Blocks.wm_relay_module_set = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("继电器模块接")
...
Blockly.Blocks.wm_water_atomizer_set = {
  init: function() {
    this.setColour(WM_EXECUTION);
    this.appendDummyInput("")
        .appendField("雾化器模块接")
...
Blockly.Blocks.wm_potentiometer_get_value = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
        .appendField('旋转电位器接')
...
Blockly.Blocks.wm_sliding_potentiometer_get_value = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
        .appendField('滑动电位器接')
...
//Joystick Module 
Blockly.Blocks.wm_joystick_module_get_value = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
        .appendField('全向摇杆接')
...
//Touch Sensor
Blockly.Blocks.wm_touch_sensor_set_mode = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_touch_sensor_get_value = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
        .appendField('单路触摸传感器接')
...
Blockly.Blocks.wm_funny_touch_sensor_get_value = {
  init: function() {
    this.setColour(WM_CONTROL);
    this.appendDummyInput("")
...
//WeHumiture Sensor
Blockly.Blocks.wm_humiture_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('温湿度传感器接')
...
//Temperature Sensor
Blockly.Blocks.wm_ds18b20_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
//Tilt Switch Sensor
Blockly.Blocks.wm_tilt_switch_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
//Flame Sensor
Blockly.Blocks.wm_flame_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('火焰传感器接')
...
//Gas Sensor
Blockly.Blocks.wm_gas_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
//PIR Sensor
Blockly.Blocks.wm_pir_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
//Color Sensor
Blockly.Blocks.wm_color_sensor_set = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_color_sensor_wb = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField("颜色识别传感器接")
...
Blockly.Blocks.wm_color_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('颜色识别传感器接')
...
//Gyro Sensor
Blockly.Blocks.wm_gyro_sensor_get_gyration = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('陀螺仪接')
...
Blockly.Blocks.wm_gyro_sensor_get_aacceleration = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('陀螺仪接')
...
//Compass Sensor
Blockly.Blocks.wm_compass_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('电子罗盘接')
...
//PM2.5 Sensor
Blockly.Blocks.wm_pm25_sensor_set_mode = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
...
Blockly.Blocks.wm_pm25_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('PM2.5传感器接')
...
Blockly.Blocks.wm_pm25_sensor_get_value_1 = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('PM2.5传感器接')
...
//Water Sensor
Blockly.Blocks.wm_water_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('雨滴传感器接')
...
//Barometer Sensor
Blockly.Blocks.wm_barometer_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('气压传感器接')
...
//UV Sensor
Blockly.Blocks.wm_uv_sensor_get_value = {
  init: function() {
    this.setColour(WM_SENSOR);
    this.appendDummyInput("")
        .appendField('紫外线传感器接')
